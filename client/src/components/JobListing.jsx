...
const JobListing = () => {
    ...
    useEffect(() => {
        ...
        setCurrentPage(1)
    }, [jobs, selectedCategories, selectedLocations, setSearchFilter])
            ...
            <div className='w-full lg:w-1/4 bg-white px-4'>
                ...
                {/* Search Filter from Hero Component */}
                {
                    isSearched && (searchFilter.title !== "" || searchFilter.location !== "") && (
                        ...
                        <>
                            <h3 className='font-meduim text-lg mb-4'>Current Search</h3>
        ...
        <a href="#job-list">
            <img
                ...
                className={`cursor-pointer ${
                    currentPage === Math.ceil(filteredJobs.length / 6) ? 'opacity-50 cursor-not-allowed' : ''
                }`}
            />
        </a>
    </div>
