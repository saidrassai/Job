    ...
    <div className='min-h-screen'>
        ...
        <div className='shadow py-4'>
            <div className='px-5 flex justify-between items-center'>
                <img onClick={e => navigate('/')} className='max-sm:w-32 cursor-pinter' src={assets.logo} alt="" />
                <div className='flex items-center gap-3'>
                    <p className='max-sm:hidden'>Welcome,RASSAI SAID</p>
                    <div className='relative group'>
                        <img className='w-8 h-8 border rounded-full' src={assets.company_icon} alt="" />
        ...
        <div className='flex items-start'>
            ...
            {/* Left Sidebar with option to add, manage job , and view applications */}
